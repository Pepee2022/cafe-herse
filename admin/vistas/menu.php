...
<body>
  <style>
    body{
    background-image: url(../img/fondo_admin.jpg); /*Fondo del login*/
    ...
    <div class="navbar navbar-inverse navbar-fixed-top" data-spy="affix" data-offset-top="100">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="inicio.php"><img class="img-responsive logo img-thumbnail" src="../img/logo.jpeg" alt="" width="175px" height="175px"></a>
        </div>
